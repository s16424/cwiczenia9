    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Przyklad1()
        {
            ...
            //    emp.Deptno,
            //    emp.Mgr
            //}).ToList(); // moznaby po prostu Emps.Where(emp => emp.Job == "Backend programmer"), ale metoda toString z emp zwraca
            //tylko ename i nr wydzialu, ale ja zmienilam i zakomentowalam
        ...
        public void Przyklad3()
        {
            ...
            Console.WriteLine("Max pensja: " + res);
        }
        ...
        {
            var res = Emps.Where(emp => emp.Salary == Emps.Max(x => x.Salary)).ToList();
            foreach (var x in res)
            {
                Console.WriteLine(x);
            }
        ...
        public void Przyklad7()
        {
            ...
            var res = from emp in Emps
                      ...
                      select new { Praca = grp.Key, LPrac = grp.Count() };

            //var res = Emps.GroupBy(x=> x.Job).Select(emp => new
            //{
            //    //Praca = emp.Job,
            //    //mp.Job,
            //    LiczbaPracowonikow = Emps.Count()
            //}).ToList();
        ...
        public void Przyklad8()
        {
            ...
            Console.WriteLine("Wynik any: " + res);
        }
        ...
        {
            var res = Emps.Where(emp => emp.Job == "Frontend programmer").OrderByDescending(emp => emp.HireDate).FirstOrDefault();
